...
public final class Lauar {
	...
	static String[] tiangans = { "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬",
			"癸" };
	...
	static String[] getTianGan(int[] date) {
		...
		Lunar1(sDObj);
		String s = "  " + cyclical(getYearCyl()) + "年" + cyclical(getMonCyl())
				+ "月" + cyclical(getDayCyl()) + "日";
